    ...
    <>
      <header className="fixed-top site__header">
        ...
        <div className={`site__navigation ${isActive ? "menu__opend" : ""}`}>
          <div className="bg__menu h-100 overflow-auto">
          ...
          <div className="menu_footer d-flex flex-column flex-md-row justify-content-between align-items-md-center w-100 p-3 bg-dark text-white">
